...
{
    public partial class DEC20USBATCH1MSAGROUP1DBContext : DbContext
    {
        public DEC20USBATCH1MSAGROUP1DBContext()
        {
        }

        public DEC20USBATCH1MSAGROUP1DBContext(DbContextOptions<DEC20USBATCH1MSAGROUP1DBContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-4T70SH2\\SQLEXPRESS;Initial Catalog=DEC20USBATCH1MSAGROUP1DB;Integrated Security=true");
            }
        }
